...
def subc():
   ...
   if id in ses:
   	...
   	print('ادات اشتراك يا حبي كلم البوره')
...
def xyz():
    ...
    print(f"[E]     \033[1;31mEXIT PROGRAM ادات تصيد نشط مربوط")

    print(f"مطور الادات البوره ستوري")
...
def Random():
    ...
    print(f"اختر كود دولتك افضل كود 21892")
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;31m [Qusai-CP😓🫶الله غالب] \nNUMBER : '+uid+'\nPASSWORD   : '+ps+ '\n------------------------------------')
